...
<body filters="queueLimit, customFilter" ng-controller="AppController" nv-file-drop="" uploader="uploader">
    <div class="container">
            ...
            <div class="navbar-collapse collapse">
              ...
              <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="../image-preview">Uploads only images (with canvas preview)</a>
                            </li>
                            <li>
                                <a href="../without-bootstrap">Without bootstrap example</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="https://github.com/nervgh/angular-file-upload">View on Github</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div ng-show="uploader.isHTML5">
                    ...
                    <div nv-file-drop="" options="{ url: '/foo' }" uploader="uploader">
                        <div class="well my-drop-zone" nv-file-over="" over-class="another-file-over-class" uploader="uploader">Another drop zone with its own settings</div>
                    </div>
                </div>
                <!-- Example: nv-file-select="" uploader="{Object}" options="{Object}" filters="{String}" -->
                Multiple
                <input multiple="multiple" nv-file-select="" type="file" uploader="uploader" />
                <br />Single
                <input nv-file-select="" type="file" uploader="uploader" /></div>
